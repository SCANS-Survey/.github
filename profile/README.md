...
See the readme files in individual repositories and [wiki pages](https://github.com/SCANS-Survey/scansapp/wiki) in the scansapp repository (under development) for instructions on how to set things up. 
